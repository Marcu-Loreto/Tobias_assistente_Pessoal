...
def select_model(
    ...
    strong_triggers = [
        "código", "debug", "erro", "analise", "análise",
        "arquitetura", "valide", "validação", "estratégia",
    ...
    cheap_triggers = [
        ...
        "resuma", "traduza", "corrija frase",
        "me diga", "obrigado", "valeu"
    ]

    if words_count <= 5 and not has_documents:
        return MODEL_GOOGLE_CHEAP
